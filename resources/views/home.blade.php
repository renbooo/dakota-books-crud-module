...
<head>
    ...
    <!-- Vendor CSS -->
    <link rel="stylesheet" href="{{asset('libs/users/bootstrap/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('libs/users/font-awesome/css/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{asset('libs/users/nivo-slider/css/nivo-slider.css')}}">
    <link rel="stylesheet" href="{{asset('libs/users/nivo-slider/css/animate.css')}}">
    <link rel="stylesheet" href="{{asset('libs/users/nivo-slider/css/style.css')}}">
    <link rel="stylesheet" href="{{asset('libs/users/font-material/css/material-design-iconic-font.min.css')}}">
    <link rel="stylesheet" href="{{asset('libs/users/slider-range/css/jslider.css')}}">
    <link rel="stylesheet" href="{{asset('libs/users/owl-carousel/assets/owl.carousel.min.css')}}">

    <!-- Template CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('css/users/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/users/reponsive.css')}}">
</head>
...
<body id="product-sidebar-left" class="product-grid-sidebar-left">
                                        ...
                                        <tr>
                                            <td class="product-image">
                                                <a href="product-detail.html">
                                                    <img src="{{asset('img/users/product/5.jpg')}}" alt="Product">
                                                </a>
                                            </td>
                                            <td>
            ...
            <div class="container">
                <div class="row">
                    <div class="text-center col-lg-12 ">
                        <span>
                            <a href="https://www.templatespoint.net" target="_blank">Templates Point</a>
                        </span>
                    </div>
                </div>
            </div>
    ...
    <!-- Vendor JS -->
    <script src="{{asset('libs/users/jquery/jquery.min.js')}}"></script>
    <script src="{{asset('libs/users/popper/popper.min.js')}}"></script>
    <script src="{{asset('libs/users/bootstrap/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('libs/users/nivo-slider/js/jquery.nivo.slider.js')}}"></script>
    <script src="{{asset('libs/users/owl-carousel/owl.carousel.min.js')}}"></script>
    <script src="{{asset('libs/users/slider-range/js/tmpl.js')}}"></script>
    <script src="{{asset('libs/users/slider-range/js/jquery.dependClass-0.1.js')}}"></script>
    <script src="{{asset('libs/users/slider-range/js/draggable-0.1.js')}}"></script>
    <script src="{{asset('libs/users/slider-range/js/jquery.slider.js')}}"></script>

    <!-- Template JS -->
    <script src="{{asset('js/users/theme.js')}}"></script>
</body>
